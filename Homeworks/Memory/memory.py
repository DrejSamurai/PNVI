...
# Измена од прашање број 6
def drawBoxWonRectAnimation(boxx, boxy, color):
    left, top = leftTopCoordsOfBox(boxx, boxy)
    pygame.draw.rect(DISPLAYSURF, color, (left - 5, top - 5, BOXSIZE + 10, BOXSIZE + 10), 4)
#----------------------------------------------------------------

# Измена од прашање број 5
...
def gameWonAnimation(board):
    ...
    for i in range(13):
        ...
        for box in boxes:
            drawBoxWonRectAnimation(box[0], box[1], color1)
        drawBoard(board, coveredBoxes)
        pygame.display.update()

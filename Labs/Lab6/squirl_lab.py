...
def main():
    ...
    pygame.display.set_icon(pygame.image.load('../../Homeworks/SquirlEatSquirl/gameicon.png'))
    DISPLAYSURF = pygame.display.set_mode((WINWIDTH, WINHEIGHT))
    pygame.display.set_caption('Squirrel Eat Squirrel')
    BASICFONT = pygame.font.Font('freesansbold.ttf', 32)

    # load the image files
    L_SQUIR_IMG = pygame.image.load('../../Homeworks/SquirlEatSquirl/squirrel.png')
    ...
    while True: # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            if random.randint(0, 99) < DIRCHANGEFREQ:
                ...
                #---------------------------------------------> Changes for 3
                sObj['movey'] = abs(getRandomVelocity())
                #----------------------------------------------------------------
        ...
        if not gameOverMode:
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    # --------------------------------------------------------> Changes for 4
                    elif sqObj['width'] * sqObj['height'] > playerObj['size']**2:
                        playerObj['size'] -= int((sqObj['width'] * sqObj['height']) ** 0.2) + 1
                        ...
                        if playerObj['size'] <= LOSESIZE:
                            gameOverMode = True # turn on "win mode"
                    #------------------------------------------------------------------------------------------------->
...
def makeNewSquirrel(camerax, cameray):
    ...
    #-------------------------------------------------> Changes for 3
    sq['movey'] = abs(getRandomVelocity())
    #---------------------------------------------------------------

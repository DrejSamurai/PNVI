...
def main():
    ...
    pygame.display.set_icon(pygame.image.load('../../Buggy_squirrel_fix/gameicon.png'))
    DISPLAYSURF = pygame.display.set_mode((WINWIDTH, WINHEIGHT))
    pygame.display.set_caption('Squirrel Eat Squirrel')
    BASICFONT = pygame.font.Font('freesansbold.ttf', 32)

    # load the image files
    #----------------------------------> Bug fix 5 mixed up names of variables should be L_SQUIR_IMG first then R_SQUIR_IMG
    # The game crashes bc L_SQUIR_IMG was called before beeing initialized
    L_SQUIR_IMG = pygame.image.load('../../Buggy_squirrel_fix/squirrel.png')
